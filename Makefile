...
CFLAGS= -Wall
BINARIES= psee-i2c-get psee-i2c-set psee-spi-get psee-spi-set
DESTDIR= usr/bin
...
install: $(BINARIES)
	...
	install -m 0755 psee-spi-get $(DESTDIR)
	install -m 0755 psee-spi-set $(DESTDIR)

clean :
	rm -f $(BINARIES)
	rm -f psee-i2c-get.o psee-i2c-set.o psee-spi-get.o psee-spi-set.o
